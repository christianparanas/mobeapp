	...
	<div class="nav">
		...
		<div class="nav-menu shadow-md" v-if="openNavMenu" v-click-outside="closeNav">
			...
			<div class="navmenufoot">
				<div class="title">built by christianparanas</div>
			</div>
		</div>
		</transition>
	</div>
