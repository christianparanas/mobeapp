<template>
  <div id="App" class="container">
    ...
    <div class="content">
      ...
      <div class="category-content">
        <ContentPreview v-for="drama in dramas.results" :content="drama" :key="drama.id" />
      </div>
    </div>
  </div>
</template>
...
export default {
  ...
  async asyncData({ $http }) {
    ...
    const dramas = await $http.$get('https://api.themoviedb.org/3/discover/movie?api_key=a807f0095433ac989503323b5b0bc933&language=en-US&sort_by=popularity.asc&include_adult=false&include_video=false&page=1&with_genres=10749');
